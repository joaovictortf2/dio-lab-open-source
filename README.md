...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/joaovictortf2`: `git checkout -b feat/community/joaovictortf2`;
...
7. Adicione suas alterações a "staging area" com o comando `git add community/joaovictortf2.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add joaovictortf2 profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/joaovictortf2`; 
